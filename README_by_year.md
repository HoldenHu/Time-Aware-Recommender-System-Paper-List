...
2. **Time Matters: Sequential Recommendation with Complex Temporal Information.** SIGIR, 2020 
   ...
   【结合时序信息的序列推荐】[auto encoders as a part of the temporal module that embeds the sequential behaviors with timestamps into dense vectors]
...
5. **Incorporating context and trends in news recommender systems.** WI, 2017. [paper](https://dl.acm.org/doi/abs/10.1145/3106426.3109433)

   *A Lommatzsch, B Kille, S Albayrak*


6. **Session-based item recommendation in e-commerce: on short-term intents, reminders, trends and discounts.** User Model. User-Adapt. Interact., 2017. [paper](https://link.springer.com/article/10.1007/s11257-017-9194-1)

   *Dietmar Jannach, Malte Ludewig & Lukas Lerche*

7. **Learning item temporal dynamics for predicting buying sessions.** IUI, 2016. [paper](https://dl.acm.org/doi/abs/10.1145/2856767.2856781)
...
1. **Opportunity Models for E-commerce Recommendation: Right Product, Right Time.** SIGIR, 2013.
